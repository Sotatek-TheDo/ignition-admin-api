// https://github.dev/anchan828/typeorm-helpers

import { BinaryLike, createHmac } from 'crypto';
import { ValueTransformer } from 'typeorm';

import { isNullOrUndefined } from '../helpers/utils.helper';
...
export class HmacTransformer implements ValueTransformer {
  private transformerOptions: Pick<HmacTransformerOptions, 'key'> &
    Required<Pick<HmacTransformerOptions, 'algorithm'>>;
