...
│├── external-modules/ # Modules that interact with external services
│├── modules
...
││     └── middleware/ #  Contains function that have access to the request and the response objects
││     └── redis/ #  redis service
││     └── transformer/ #  Transform functions
││     └── database/ #  Database module contains database configuration and connection
││     └── cache/ #  Cache module contains cache configuration and connection
